...
export function TextEffect({
  ...
  // Use pre-defined stable motion component to prevent unmounting on every render
  const MotionComponent = motionComponents[Component] || motion[Component] || motion.span;
...
export function TextEffectPerChar({
  ...
  return (
    <TextEffect per="char" preset="fade" {...props}>
      {children}
    </TextEffect>
  );
}
